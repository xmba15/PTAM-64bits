...
{
	using namespace std;
	void fast_corner_detect_plain_7(const cv::Mat &i, std::vector<cv::Point> &corners, int b);
	int fast_corner_score_7(const uchar* cache_0, const int offset[], int b);
	void fast_corner_detect_plain_8(const cv::Mat &i, std::vector<cv::Point> &corners, int b);
	int fast_corner_score_8(const uchar* cache_0, const int offset[], int b);
	void fast_corner_detect_plain_9(const cv::Mat &i, vector<cv::Point> &corners, int b);
   ...
   void fast_corner_detect_plain_11(const cv::Mat &i, vector<cv::Point> &corners, int b);
   int fast_corner_score_11(const uchar* cache_0, const int offset[], int b);
   
    void fast_corner_detect_plain_12(const cv::Mat &i, vector<cv::Point> &corners, int b);
